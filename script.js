...
/* ==========================================================================
   ...
   ========================================================================== */
const LEGAL = {
  privacy: `<h4>Who We Are</h4><p>Uncle Ratt ("we", "us") is a Nairobi-based retailer of wines and spirits and the controller of the personal data described below.</p>
  <h4>Information We Collect</h4><p>When you place an order we collect your name, phone number and delivery address, plus the items in your order. We don't collect or store card or payment details ourselves — checkout is completed with our team over WhatsApp.</p>
  <h4>Cookies &amp; Local Storage</h4><p>Your cart contents and light/dark mode preference are stored in your browser's local storage. This stays on your device and is not sent to us until you check out.</p>
  <h4>Third Parties</h4><p>Product and order data is stored using Google Firebase (Firestore and Cloud Storage). Completed orders are sent to us via WhatsApp, operated by Meta, and are subject to Meta's own privacy policy once sent. We do not sell customer data to advertisers or any other third party.</p>
  <h4>How We Use Your Information</h4><p>We use your details to process orders, confirm delivery and respond to enquiries.</p>
  <h4>Data Retention</h4><p>Order records are kept for as long as reasonably needed for business and legal record-keeping purposes, after which they are deleted.</p>
  <h4>Your Rights</h4><p>Under Kenya's Data Protection Act, 2019, you may request access to, correction of, or deletion of your personal data by contacting us below.</p>
  ...
  <h4>Contact</h4><p>Questions about this policy can be sent to bromtrader199@gmail.com.</p>`,
